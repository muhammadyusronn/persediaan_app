...
include 'php/pengeluaran-cart.php';
?>
<div class="content-wrapper">
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="barang-masuk.php">Transaksi Barang Keluar</a></li>
            <li class="breadcrumb-item">Tambah Transaksi Barang Keluar</li>
        </ol>
    </div>
    <div class="page-content fade-in-up">
        ...
        <?php if (isset($_SESSION['keranjang_keluar'])) { ?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-head">
                        ...
                        <div class="ibox-body">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $total = 0;
                                    foreach ($_SESSION['keranjang_keluar'] as $i) :
                                        $total = $total + ($i['hargabarang'] * $i['jumlahkeluar']);
                                    ?>
                                        <tr>
                                            <td><?= $i['idbarang'] ?></td>
                                            <td><?= $i['namabarang'] ?></td>
                                            ...
                                            <td><?= rupiah($i['hargabarang'] * $i['jumlahkeluar']) ?></td>
                                            <td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="barang-keluar-checkout.php" class="btn btn-success" title="CHECKOUT"><i class="fa fa-money"></i></a>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" method="post" action="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="hidden" name="hargabarang" value="<?= $row['harga'] ?>" readonly>
                                    <input class="form-control" type="text" name="hargabarang1" value="<?= rupiah($row['harga']) ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="number" name="jumlahkeluar" required>
                                </div>
                            </div>
                            <div class="form-group row">
