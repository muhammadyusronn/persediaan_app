...
<body>
  ...
  <?php
  $q = "SELECT * from tb_barangkeluar where kodetransaksi='$_GET[id]'";
  // echo $q;
  // die();
  ...
  while ($data = mysqli_fetch_array($sql)) { ?>
    <table class="table" width="100" % style="width:210mm" align="left" border="0">
      ...
      <tr>
        <th width="120" height="25" align="left">Nama Konsumen</th>
        <th width="20" height="25" align="left">:</th>
        <th width="400" height="25" align="left"><?php echo $data['konsumen']; ?></th>
      </tr>
      <tr>
        <th width="120" height="25" align="left">Kontak</th>
        <th width="20" height="25" align="left">:</th>
        <th width="400" height="25" align="left"><?php echo $data['kontak']; ?></th>
      </tr>
      <tr>
        <th width="120" height="25" align="left">Total Belanja</th>
        <th width="20" height="25" align="left">:</th>
        <th width="400" height="25" align="left"><?php echo rupiah($data['totalbelanja']); ?></th>
      </tr>
      <tr>
  ...
  <table class="table" width="100" % style="width:210mm" align="center" border="1">
    ...
    <?php
    $nox = 1;
    $sql1 = "SELECT * FROM tb_detailkeluar WHERE kodetransaksi='$_GET[id]'";
...
<?php
$filename = "Bukti Bahan Keluar " . $_GET['id'] . "__" . date('d-m-Y') . ".pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
//==========================================================================================================
