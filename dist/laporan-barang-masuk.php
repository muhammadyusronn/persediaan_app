...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Laporan Transaksi Barang Masuk</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="index.php"><i class="fa fa-home font-20"></i></a>
            </li>
            <li class="breadcrumb-item">Laporan Transaksi Barang Masuk</li>
        </ol>
    </div>
    <div class="page-content fade-in-up">
        ...
        <?php } else { ?>
            ...
            <div class="ibox">
                <div class="ibox-head">
                    <div class="ibox-title">Laporan Transaksi Barang Masuk</div>
                </div>
                <div class="ibox-body">
                    <table class="table table-striped table-bordered table-hover" id="laporan-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php $sql = mysqli_query($koneksi, "SELECT * FROM tb_barangmasuk WHERE tanggaltransaksi BETWEEN '$_POST[mulaidari]' AND '$_POST[sampai]'");
