...
<div class="content-wrapper">
                        ...
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td><?= rupiah($total); ?></td>
                                    <td>
                                        <a href="barang-keluar-add.php?cancel=true" class="btn btn-danger" onclick="javascript: return confirm('Anda yakin membatalkan transaksi?')" title="CANCEL"><i class="fa fa-times"></i> CANCEL</a>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            ...
            <div class="ibox-body">
                <form class="form-horizontal" action="php/barang-keluar.php" method="POST">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nama Konsumen</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="konsumen">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="hidden" value="<?= $total ?>" name="totalbelanja" readonly>
                            <input class="form-control" type="text" value="<?= rupiah($total) ?>" name="total" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
